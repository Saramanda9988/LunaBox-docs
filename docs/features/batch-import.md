...
- 系统默认使用上一级文件夹名称作为搜索名称，如果您想重新搜索，请在修改名称后点击获取元信息按钮
...
- 如果您认为游戏匹配错误，可以点击编辑按钮，选择这次获取中其他源的结果或者通过 ID 手动搜索
...
## 注意事项
- LunaRain保存的游戏名是元数据中获取的游戏名/用于搜索的游戏名（未匹配的游戏），如果游戏名称已存在，系统会跳过该游戏，确保不重复导入
- 元数据匹配过程需要网络连接
